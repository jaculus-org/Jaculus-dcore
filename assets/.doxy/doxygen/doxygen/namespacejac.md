...
| struct | [**HasNodeModuleLoader**](structjac_1_1HasNodeModuleLoader.md) &lt;class Machine&gt;<br> |
...
| Type | Name |
| ---: | :--- |
|  constexpr bool | [**HasNodeModuleLoader\_v**](#variable-hasnodemoduleloader_v)   = `[**HasNodeModuleLoader**](structjac_1_1HasNodeModuleLoader.md)&lt;Machine&gt;::value`<br> |
...
### variable HasNodeModuleLoader\_v 

```C++
constexpr bool jac::HasNodeModuleLoader_v;
```
